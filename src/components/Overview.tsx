  ...
  return (
    <div className="p-4 lg:p-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl lg:text-3xl font-semibold text-gray-900">Website Overview</h1>
          <p className="mt-1 text-sm text-gray-500">Your website's performance in the last 30 days</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 p-6">
          <div className="mb-6">
            <h2 className="text-lg font-semibold text-gray-900">Website Traffic Trend</h2>
            <p className="text-sm text-gray-500 mt-1">Visitors and page views over time</p>
          </div>
              ...
              <div key={page.page} className="flex items-center justify-between py-3 border-b border-gray-100 last:border-0">
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-xs text-gray-500">{page.time} avg. time</p>
                  </div>
                </div>
